...
theme.set_highlights = function(opts)
    ...
    hl(0, "Constant", { fg = c.gruvBlue, bg = "NONE" })
    ...
    hl(0, "Repeat", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "Label", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "Operator", { fg = c.vscGrey, bg = "NONE" })
    ...
    hl(0, "Delimiter", { fg = c.vscGrey, bg = "NONE" })
    ...
    hl(0, "@preproc", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@define", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@punctuation.bracket", { fg = c.vscGrey, bg = "NONE" })
    hl(0, "@punctuation.special", { fg = c.vscGrey, bg = "NONE" })
    hl(0, "@comment", { fg = c.vscGreen, bg = "NONE", italic = opts.italic_comments })
    hl(0, "@constant", { fg = c.gruvBlue, bg = "NONE" })
    ...
    hl(0, "@function.call", { fg = c.gruvGold, bg = "NONE" })
    ...
    hl(0, "@constructor", { fg = c.vsaOrange, bg = "NONE" })
    hl(0, "@conditional", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@repeat", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@label", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@keyword", { fg = c.gruvRed, bg = "NONE" })
    ...
    hl(0, "@keyword.return", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@operator", { fg = c.vscGrey, bg = "NONE" })
    hl(0, "@exception", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@type", { fg = c.vsaGold, bg = "NONE" })
